...
detector = cv2.CascadeClassifier("D:/Projects/User Verification/haarcascade_frontalface_default.xml")
...
faces,ids = getImagesAndLabels('D:/Projects/User Verification/dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists('D:/Projects/User Verification/trainer/')    # Save the model into trainer.yml
recognizer.save('D:/Projects/User Verification/trainer/trainer.yml')
