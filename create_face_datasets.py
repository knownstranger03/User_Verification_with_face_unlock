...
face_cascade = cv2.CascadeClassifier('D:/Projects/User Verification/haarcascade_frontalface_default.xml') # Detect object in video stream using Haarcascade Frontal Face
