...
assure_path_exists("D:/Projects/User Verification/trainer/")

recognizer.read('D:/Projects/User Verification/trainer/trainer.yml')  #load training model

cascadePath = "D:/Projects/User Verification/haarcascade_frontalface_default.xml"  #cascade path
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if(confidence>80):                 #confidence usually comes greater than 80 for strangers
            ...
            Id = "Krishna Prasad + {0:.2f}%".format(round(100 - confidence, 2)) 
            print("Verified")
            print(confidence)
            counter_correct += 1
